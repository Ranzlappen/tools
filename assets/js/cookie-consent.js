...
(function () {
  ...
  var STORAGE_KEY = 'tools:cookie_consent';
      ...
      '<div class="cc-banner__inner">' +
        ...
        '<div class="cc-banner__content">' +
          ...
          '<p class="cc-banner__desc">' +
            'This site stores your theme and header preferences locally (always on). ' +
            'The only optional feature is on-site Search, which loads a small local index from this domain. ' +
            'You choose whether to enable it.' +
          '</p>' +
        '</div>' +
        ...
        '<div class="cc-banner__settings" id="cc-settings" hidden>' +
          ...
          '<div class="cc-category">' +
            ...
            '</div>' +
            '<p class="cc-category__desc">' +
              'On-site Search index, loaded from this domain. No third-party trackers, no analytics.' +
            '</p>' +
          '</div>' +
        '</div>' +
